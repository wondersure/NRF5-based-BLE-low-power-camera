...
extern uint8_t Frame_Buffer[ HM01B0_X_NUM * HM01B0_Y_NUM+13];
...
//						  }
						  ...
						  /*Added by Ali*/
                                                  mcu[cur_height*mcu_size*pixel_size_by_byte + cur_width]=Frame_Buffer[(cur_mcu_height*mcu_size + cur_height)*width*pixel_size_by_byte + (cur_mcu_width*mcu_size*pixel_size_by_byte + cur_width)];
